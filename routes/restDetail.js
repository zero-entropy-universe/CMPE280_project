...
module.exports = function (firebase) { // firebase
   router.get('/:id', function(req, res) {
      ...
      var ref = firebase.database().ref("restaurant").child('-KighKkTqQ9DhIuMGg9f'); // -KighKkTqQ9DhIuMGg9f
      ...
      ref.once("value").then(function (snapshot) {
        ...
        console.log(restaurantOption, 'ya');
        // console.log(snapshot, 'ya2');
        res.render("pages/restDetail", {restaurantList : restaurantOption});
      });
      /*
